define([
   ...
   */
  var routeMap = {};
  var lifeCycleHooks = [ 'beforeModel' ];
  ...
  function Route(name, proto, dontRegister) {
    var props = omit(proto, lifeCycleHooks.concat('mixins'));
    var hooks = pick(proto, lifeCycleHooks);
    ...
    lifeCycleHooks.forEach(function(hookName) {
      ...
      var mixinHooks = pluck(mixins, hookName);
