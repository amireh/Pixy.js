define([
  ...
  merge(Store.prototype, Logger, Events, {
     ...
     * @param {Function} callback
     */
    addActionErrorListener: function(action, callback) {
      this.on(actionErrorEventName(action), callback);
    },

    removeActionErrorListener: function(action, callback) {
      this.off(actionErrorEventName(action), callback);
    },
    ...
    addErrorListener: function(callback) {
      this.on(ACTION_ERROR_EVENT, callback);
    },

    removeErrorListener: function(callback) {
      this.off(ACTION_ERROR_EVENT, callback);
    },
