define([
  ...
  extend(Store.prototype, Logger, Events, {
    ...
    emitActionSuccess: function(action, actionIndex) {
      this.trigger(actionSuccessEventName(action), actionIndex);
    },
     ...
     * @param {Function} callback
     */
    addActionSuccessListener: function(action, callback, thisArg) {
      this.on(actionSuccessEventName(action), callback, thisArg);
    },

    removeActionSuccessListener: function(action, callback, thisArg) {
      this.off(actionSuccessEventName(action), callback, thisArg);
    },
    ...
    _errorPropagator: function(action) {
      return function(error) {
        if (error && RESPONSE_JSON in error) {
    ...
    _actionEmitter: function(action) {
      return function() {
