define([
  ...
  './history',
  'router'
], function(_, PObject, history, Router) {
  // Pixy.Router
  // ---------------
  ...
  // applicationRouter = new Router['default']();
  ...
  var Router = PObject.extend({
    ...
    // routeMap: function(callback) {
    //   this.legacyRouter = false;
    //   applicationRouter.map(callback);
    // },
