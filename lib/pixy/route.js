define([
  ...
  './core/router',
  './mixins/events'
], function(_, extendPrototype, Pixy, Registry, Router, Events) {
  var extend = _.extend;
  var omit = _.omit;
  var pick = _.pick;
  var pluck = _.pluck;
  ...
  function Route(name, proto, dontRegister) {
    ...
    mixinMethods = mixins.reduce(function(methods, mixin) {
      var mixinMethods = mixin.mixinMethods || {};
      ...
      extend(methods, mixinMethods);
      return methods;
    }, {});

    extend(this, proto, mixinMethods, {
      name: name
    });
